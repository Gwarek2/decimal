...
void my_print_num(s21_decimal value) {
    for (int i = 3; i > -1; i--) {
            if(value.bits[i] == 4294967295) {
                printf("max32bit");
            } else {
...
void my_print_num_reverce(s21_decimal value) {
    for (int i = 0; i < 4; i++) {
            if (value.bits[i] == 4294967295) {
                printf("max32bit");
            } else {
...
void my_print_192_num(uint192 value) {
    for (int i = 5; i > -1; i--) {
            printf("%u", value.bits[i]);
            printf(",");
        }
...
int main() {
    ...
    // uint192 value_1 = {10,0,0,0,0,0};
    // uint192 value_2 = {3,0,0,0,0,0};
    // s21_decimal result = {{0}};
    uint192 remainder = {0};
    // divide_uint192(value_1, value_2, &result, &remainder);
    s21_decimal value_1 = {{0, 0, 0, 0}};
    s21_decimal value_2 = {{2452, 45646, 4564, 0}};
    s21_decimal result = {0};
    set_scale(&value_1, 12);
    set_scale(&value_2, 17);
    my_print_num_reverce(value_1);
    my_print_num_reverce(value_2);
    printf("%d\n", s21_mod(value_1, value_2, &result));
    my_print_num_reverce(result);
